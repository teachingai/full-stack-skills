---
name: uniapp-uview-guide
description: A comprehensive skill for integrating and using uView UI with UniApp projects. This skill focuses on how to integrate uView UI into UniApp applications, configure UniApp projects to work with uView, handle platform-specific behaviors, and leverage UniApp features with uView components. Use this skill whenever the user needs to build UniApp applications using uView UI component library.
...
- Configure UniApp projects to work with uView UI
- Handle platform-specific behaviors when using uView in UniApp
- Use UniApp features (pages.json, manifest.json, etc.) with uView
- Build cross-platform UniApp applications with uView UI
- Configure easycom for automatic uView component import in UniApp
- Handle navigation and routing with uView in UniApp
- Use UniApp APIs with uView components
- Optimize UniApp projects using uView UI

## How to use this skill

To use uView UI with UniApp:

1. **Install and integrate** uView into UniApp project:
