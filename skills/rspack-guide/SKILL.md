---
name: rspack-guide
description: Rspack 完整使用指南，基于官方文档（https://rspack.rs/zh/），涵盖快速上手、配置、插件、API 等核心概念和最佳实践。Rspack 是一个基于 Rust 的高性能 JavaScript 打包工具，与 Webpack 兼容，提供更快的构建速度。适用于需要高性能构建的 JavaScript/TypeScript 项目。
