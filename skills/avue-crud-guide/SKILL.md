---
name: avue-crud-guide
description: Avue CRUD 表格组件完整使用指南，基于官方文档（https://avuejs.com/crud/crud-doc.html），涵盖 CRUD 表格的配置、列定义、增删改查操作、分页、搜索、排序、导出等核心功能和最佳实践。适用于使用 Avue CRUD 快速开发数据管理功能的场景。
