---
name: uniapp-plugin-guide
description: A comprehensive skill for uni-app plugin market and automatic plugin installation. Use this skill whenever the user wants to use plugins from the uni-app plugin market, automatically install plugins, configure plugin settings, or integrate third-party plugins into uni-app projects. This skill provides complete documentation, examples, and best practices based on the official plugin market documentation.
