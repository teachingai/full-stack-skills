---
name: pinia-guide
description: Pinia 完整使用指南，基于官方文档（https://pinia.vuejs.org/），涵盖状态管理、Store 定义、State、Getters、Actions、组合式 Store、选项式 Store、SSR、插件等核心概念和最佳实践。适用于使用 Pinia 在 Vue 3 应用中实现状态管理的场景。
