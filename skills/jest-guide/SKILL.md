---
name: jest-guide
description: Jest 完整使用指南，基于官方文档（https://jestjs.io/docs/getting-started、https://jestjs.io/docs/api），涵盖测试编写、匹配器、异步测试、Mock、快照测试、配置、CLI、API 等核心概念和最佳实践。适用于使用 Jest 进行 JavaScript/TypeScript 单元测试和集成测试的场景。
