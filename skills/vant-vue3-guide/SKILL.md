---
name: vant-vue3-guide
description: Vant Vue 3.0 完整使用指南，基于官方文档（https://vant-ui.github.io/vant/#/zh-CN），涵盖移动端 Vue 3 组件使用、主题定制、国际化、TypeScript 支持等核心概念和最佳实践。适用于使用 Vant 构建移动端 Vue 3 应用的场景。
