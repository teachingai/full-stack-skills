---
name: spring-cloud-alibaba-guide
description: Spring Cloud Alibaba 开发指南，包括 Nacos、Sentinel、RocketMQ、Seata 等阿里云微服务组件和最佳实践。适用于使用 Spring Cloud Alibaba 构建微服务架构的场景。
---
