---
name: spring-ai-guide
description: Spring AI 开发指南，包括 Chat Client、Embedding、Vector Store、Prompt Template、Function Calling 等核心功能和最佳实践。适用于使用 Spring AI 集成大语言模型的场景。
---
