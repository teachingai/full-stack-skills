---
name: avue-form-guide
description: Avue-form 完整使用指南，基于官方文档（https://avuejs.com/form/form-doc.html），涵盖表单组件安装、配置、使用、API 参考等核心概念和最佳实践。Avue-form 是一个基于 Vue 的表单组件库，提供丰富的表单控件和配置选项。
