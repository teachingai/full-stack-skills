---
name: uview-vue2-guide
description: uView UI Vue 2.0 完整使用指南，基于官方文档（https://www.uviewui.com/），涵盖 uni-app + Vue 2 组件使用、工具函数、主题定制、UniApp 集成等核心概念和最佳实践。适用于使用 uView UI 构建 uni-app 应用的场景。
