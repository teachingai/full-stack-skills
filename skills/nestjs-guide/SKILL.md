---
name: nestjs-guide
description: NestJS 完整使用指南，基于官方文档（https://docs.nestjs.com/），涵盖控制器、提供者、模块、中间件、守卫、拦截器、异常过滤器、管道、数据库集成、验证、缓存、安全、GraphQL、WebSockets、微服务、测试等核心概念和最佳实践。适用于使用 NestJS 构建 Node.js 后端应用的场景。
