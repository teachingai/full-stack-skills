---
name: lime-echart-guide
description: A comprehensive skill for using lime-echart in UniApp and UniAppX projects. lime-echart provides ECharts chart compatibility support for UniApp and UniAppX, enabling ECharts charts to run in H5, mini-programs, and App environments. Use this skill whenever the user needs to create, configure, or customize ECharts charts in UniApp/UniAppX applications.
