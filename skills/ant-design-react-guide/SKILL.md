---
name: ant-design-react-guide
description: Ant Design React 4.x 完整使用指南，基于官方文档（https://4x-ant-design.antgroup.com/），涵盖组件使用、设计规范、主题定制、国际化、TypeScript 支持等核心概念和最佳实践。适用于使用 Ant Design React 构建企业级中后台应用的场景。
