---
name: nextjs-guide
description: Next.js 完整使用指南，基于官方文档（https://nextjs.org/docs），涵盖 App Router 和 Pages Router、路由、数据获取、渲染策略、API 路由、中间件、优化等核心概念和最佳实践。适用于使用 Next.js 开发全栈 React 应用的场景。
