---
name: bootstrap-vue3-guide
description: Bootstrap Vue 3.0 完整使用指南，基于官方文档（https://bootstrap-vue.org），涵盖 Vue 3 + Bootstrap 组件使用、指令、表单、表格、模态框等核心概念和最佳实践。适用于使用 Bootstrap Vue 3.0 构建 Vue 3 应用的场景。
