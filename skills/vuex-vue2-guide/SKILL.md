---
name: vuex-vue2-guide
description: Vuex 完整使用指南，基于官方文档（https://vuex.vuejs.org/zh/），涵盖安装、核心概念、状态管理、模块化、API 参考等核心概念和最佳实践。Vuex 是一个专为 Vue.js 应用程序开发的状态管理模式，采用集中式存储管理应用的所有组件的状态。
